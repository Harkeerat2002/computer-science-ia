...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText userAge,userGender,userLanguage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userGender = findViewById(R.id.regGender);
        userLanguage = findViewById(R.id.regLanguage);
        ...
        regBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if( email.isEmpty() || name.isEmpty() || password.isEmpty()  || !password.equals(password2)) {
                    ...
                    CreateUserAccount(email,name,password,age,gender,language);
                }
    ...
    private void CreateUserAccount(String email, final String name, String password,final String age, final String gender, final String language) {
