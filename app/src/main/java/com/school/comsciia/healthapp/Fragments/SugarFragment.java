...
public class SugarFragment extends Fragment {
    ...
    public static SugarFragment newInstance(String param1, String param2) {
        SugarFragment fragment = new SugarFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sugarValue = (EditText) view.findViewById(R.id.sugarValue);
        ...
        lineChart = (LineChart) view.findViewById(R.id.lineChart);
          ...
          saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String sugar = sugarValue.getText().toString();
    ...
    private void SaveData(final String sugar) {

        DateValue value = new DateValue(sugar);

        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Sugar")
    ...
    private void showChart(ArrayList<Entry> dataVals){
        ...
        lineDataSet.setLabel("Sugar Chart");
        iLineDataSets.clear();
        ...
        lineChart.saveToGallery("Sugar.jpg");
    }
